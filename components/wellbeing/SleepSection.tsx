...
export default function SleepSection({
  ...
  const p1_remPercent =
    p1_total > 0
      ? Math.round((p1StageSummary.total_rem_sleep_time_milli / p1_total) * 100)
      : 0;
  const p1_swsPercent =
    p1_total > 0
      ? Math.round(
      ...
      : 0;
  const p1_lightPercent =
    p1_total > 0
      ? Math.round(
          (p1StageSummary.total_light_sleep_time_milli / p1_total) * 100,
        )
      : 0;
  const p1_awakePercent =
    p1_total > 0
      ? Math.round((p1StageSummary.total_awake_time_milli / p1_total) * 100)
      : 0;
  ...
  const p2_remPercent =
    p2_total > 0
      ? Math.round((p2StageSummary.total_rem_sleep_time_milli / p2_total) * 100)
      : 0;
  const p2_swsPercent =
    p2_total > 0
      ? Math.round(
      ...
      : 0;
  const p2_lightPercent =
    p2_total > 0
      ? Math.round(
          (p2StageSummary.total_light_sleep_time_milli / p2_total) * 100,
        )
      : 0;
  const p2_awakePercent =
    p2_total > 0
      ? Math.round((p2StageSummary.total_awake_time_milli / p2_total) * 100)
      : 0;
