...
export default function TableItem({
  ...
  const calculateTransform = () => {
    ...
    if (basePosition.y > 0) {
      ...
      const itemHeight = 179; // 100px height + 200px margins (100 top + 100 bottom)
  ...
  // Report position to parent when measured
  useEffect(() => {
    if (basePosition.y > 0 && onPositionMeasured) {
      onPositionMeasured(basePosition.y);
    }
  }, [basePosition.y, onPositionMeasured]);
